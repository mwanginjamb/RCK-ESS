...
$this->title = 'HRMIS - Long Term  Performance Appraisal Status';
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Long Term Performance Appraisals Status</h3>
                </div>
                <div class="card-body">
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'appraisal/long-term-status',
            paging: true,
             columns: [
                ...
                { title: 'Mid Year Status' ,data: 'MY_Appraisal_Status'},
