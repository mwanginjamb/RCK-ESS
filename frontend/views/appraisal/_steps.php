...
<div class="breadcrumbb flat">
        ...
        <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'appraisal/view?Employee_No='.$model->Employee_No.'&Appraisal_No='.$model->Appraisal_No ?>" <?= ($model->Goal_Setting_Status == 'Closed' && $model->MY_Appraisal_Status == 'Appraisee_Level')?'class="active"': '' ?>>Mid Year Appraisal</a>
...
<!-- 
        <a href="<?php  Yii::$app->recruitment->absoluteUrl() .'appraisal/view?Employee_No='.$model->Employee_No.'&Appraisal_No='.$model->Appraisal_No ?>" <?= ($model->MY_Appraisal_Status == 'Closed' && $model->EY_Appraisal_Status == 'Agreement_Level')?'class="active"': '' ?>>Training Plan & Training Assessment</a>
 -->
