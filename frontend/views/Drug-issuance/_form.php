                ...
                <div class="row">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <?= $form->field($model, 'Patient_Name')->textInput(['maxlength' =>  100]) ?>
                            <?= $form->field($model, 'Patient_Card_No')->textInput(['maxlength' =>  100]) ?>
                            <?= $form->field($model, 'Patient_Diagnosis')->textInput(['maxlength' =>  100]) ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <?= $form->field($model, 'Global_Dimension_3_Code')->dropDownList($students,['prompt' => 'Select Student ..']) ?>
