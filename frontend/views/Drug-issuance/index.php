...
$this->params['breadcrumbs'][] = ['label' => 'Drug Issuance List', 'url' => ['index']];
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
        <?= \yii\helpers\Html::a('New Prescription Requisition',['create'],['class' => 'btn btn-info push-right', 'data' => [
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Drug Requisition List</h3>
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            columns: [
                ...
                { title: 'Patient Card No' ,data: 'Patient_Card_No'},
                
                { title: 'Patient Diagnosis' ,data: 'Patient_Diagnosis'},
           ...
           language: {
                "zeroRecords": "No Drug Prescription Requisitions to display ..."
            },
