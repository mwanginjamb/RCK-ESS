...
$this->params['breadcrumbs'][] = ['label' => 'Taxie Requisition List', 'url' => ['index']];
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
        <?= \yii\helpers\Html::a('New Taxie Requisition',['create'],['class' => 'btn btn-info push-right', 'data' => [
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Taxie Requisition List</h3>
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            columns: [
                ...
                { title: 'Taxi Company Name' ,data: 'Taxi_Company_Name'},
           ...
           language: {
                "zeroRecords": "No Taxie Requisitions to display"
            },
