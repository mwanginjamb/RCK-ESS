...
$this->params['breadcrumbs'][] = ['label' => 'Rejection List', 'url' => ['srejected']];
?>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Supervisor Rejected Requests</h3>
    ...
    $(function(){
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#approvals').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute +'approvals/super-rejected',
            paging: true,
            columns: [
           ...
           language: {
                "zeroRecords": "No Requests to display for now."
            },
