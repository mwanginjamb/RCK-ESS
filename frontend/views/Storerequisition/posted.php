...
$this->params['breadcrumbs'][] = ['label' => 'Posted Store Req. Pending List', 'url' => ['posted']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Posted Store Requisition List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'storerequisition/list-posted',
            paging: true,
            columns: [
                { title: 'No' ,data: 'No'},
                { title: 'Employee No' ,data: 'Employee_No'},
                { title: 'Employee Name' ,data: 'Employee_Name'},
                { title: 'Program Code' ,data: 'Global_Dimension_2_Code'},
           ...
           language: {
                "zeroRecords": "No Posted Store Requisitions to display"
            },
