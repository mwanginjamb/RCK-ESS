...
$this->params['breadcrumbs'][] = ['label' => 'Medical Cover Claim List', 'url' => ['index']];
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
        <?= \yii\helpers\Html::a('New Medical Cover Claim Request',['create'],['class' => 'btn btn-info push-right', 'data' => [
            'confirm' => 'Are you sure you want to create a new Medical Cover Claim Request?',
            'method' => 'get',
        ],]) ?>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Medical Cover Claim List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
           ...
           language: {
                "zeroRecords": "No Medical Cover Claims to display"
            },
