...
$this->title = 'COGRI - New Contract List';
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">My Contract Renewal List  &nbsp;    <?= Html::a('<i class="fa fa-plus-square"></i> Create a Renewal Request',['create'],['class' => 'add-objective btn btn-outline-info btn-sm']) ?></h3>
    ...
    $(function(){
        ...
        // $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'contract/getrenewals',
            paging: true,
            columns: [
