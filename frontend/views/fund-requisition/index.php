...
$this->params['breadcrumbs'][] = ['label' => 'Fund Request List', 'url' => ['index']];
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
        <?= \yii\helpers\Html::a('New Fund Request',['create'],['class' => 'btn btn-info push-right', 'data' => [
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Fund Requisition List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'fund-requisition/getrequests',
            paging: true,
            columns: [
                { title: 'No' ,data: 'No'},
                ...
                { title: 'Gross Allowance' ,data: 'Gross_Allowance'},
           ...
           language: {
                "zeroRecords": "No Fund Requests to Display"
            },
