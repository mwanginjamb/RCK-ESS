...
$this->params['breadcrumbs'][] = ['label' => 'Approved Request List', 'url' => ['approved']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Purchase Requisition List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'purchase-requisition/list-approved',
            paging: true,
            columns: [
                { title: 'No' ,data: 'No'},
           ...
           language: {
                "zeroRecords": "No Purchase Requisitions to display"
            },
