...
$this->params['breadcrumbs'][] = ['label' => 'Initiated Requisition List', 'url' => ['initiated']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Initiated Purchase Requisition List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'purchase-requisition/list-initiated',
            paging: true,
            columns: [
                { title: 'No' ,data: 'No'},
                ...
                { title: 'Program Coode' ,data: 'Global_Dimension_2_Code'},               
                { title: 'Requisition Date' ,data: 'Created_On'},               
                { title: 'Status' ,data: 'Status'},
                { title: 'Action', data: 'Action' },
                               
            ] ,                              
           language: {
                "zeroRecords": "No Initiated Purchase Requisitions to display"
            },
