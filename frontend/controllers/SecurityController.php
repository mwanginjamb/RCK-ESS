...
class SecurityController extends Controller
{
    ...
    public function actionCreate($Form_No,$Exit_no, $Employee_no){
        ...
        if(Yii::$app->request->post() && Yii::$app->navhelper->loadpost(Yii::$app->request->post()['Security'],$model)  && $model->validate() ){
    ...
    public function actionDelete(){
        $service = Yii::$app->params['ServiceName']['Lab'];
