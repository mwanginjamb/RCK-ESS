...
class IctController extends Controller
{
    ...
    public function actionCreate($Exit_no, $Employee_no){
        ...
        if(Yii::$app->request->post() && Yii::$app->navhelper->loadpost(Yii::$app->request->post()['Ict'],$model)  && $model->validate() ){
