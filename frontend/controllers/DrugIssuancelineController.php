...
class DrugIssuancelineController extends Controller
{
    ...
    public function actionCreate($No){
       ...
       $model = new DrugIssuanceline();
        ...
        if(Yii::$app->request->get('No') && !isset(Yii::$app->request->post()['DrugIssuanceline'])){
        ...
        if(Yii::$app->request->post() && Yii::$app->navhelper->loadpost(Yii::$app->request->post()['DrugIssuanceline'],$model) ){
